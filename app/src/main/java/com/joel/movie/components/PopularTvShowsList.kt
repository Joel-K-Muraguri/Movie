...
@Composable
fun TvPopularItems(mainViewModel : MainViewModel = hiltViewModel(), ){
    Box(contentAlignment = Alignment.Center) {
        Column() {
            ...
            PopularTvShowsList(popularTvShows = mainViewModel.popularTvShows, )
        }
    }
}

@Composable
fun PopularTvShowsList(
